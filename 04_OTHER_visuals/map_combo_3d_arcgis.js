 ...
 * MODIFICATION 2: Added Manual Dependency Loader (DeckGL, ArcGIS, TopoJSON) for CDN support.
...
looker.plugins.visualizations.add({
  id: "map_combo_3d_arcgis_cdn",
  label: "Combo Map 3D ArcGIS (v58 Hybrid)",
  options: {
    // --- 1. PLOT TAB ---
  ...
  create: function (element, config) {
    ...
    element.innerHTML = `
      ...
      <div id="map-wrapper">
        ...
        <div id="token-error">MISSING ARCGIS API KEY<br><span style="font-size:0.8em; font-weight:normal">Please enter your ArcGIS API Key in the "Plot" settings.</span></div>
      </div>`;
  ...
  _getStaticMapUrl: function (config, viewState, width, height) {
    ...
    const rawUrl = [
      ...
      `&bboxSR=4326&size=${width},${height}&imageSR=102100`,
      `&scale=${scale}&format=png&f=image`,
