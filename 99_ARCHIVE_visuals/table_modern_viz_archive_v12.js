 ...
 * Only missing pivot and column resizing
...
const visObject = {
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    // ✅ Store full processed data (without GT) for comparison peer detection
    ...
    // ✅ FIX: Always append grand total row at the end of EVERY page
    if (grandTotalRow) {
      paginatedData = [...paginatedData, grandTotalRow];
    }
