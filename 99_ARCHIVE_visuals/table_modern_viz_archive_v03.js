...
const visObject = {
  ...
  options: {
    ...
    subtotals_divider: { type: "string", label: "──────────────── Subtotals & Hierarchy ────────────────", display: "divider", section: "Series", order: 73 },
    enable_bo_hierarchy: { type: "boolean", label: "Enable BO-Style Hierarchy", default: false, section: "Series", order: 74 },
    hierarchy_dimensions: { type: "string", label: "Hierarchy Levels (comma-separated)", display: "text", default: "", placeholder: "dim1,dim2,dim3", section: "Series", order: 75 },
    enable_subtotals: { type: "boolean", label: "Enable Subtotals (Standard Mode)", default: false, section: "Series", order: 76 },
    subtotal_dimension: { type: "string", label: "Group By Dimension (Standard)", display: "select", values: [{"None": ""}], default: "", section: "Series", order: 77 },

    subtotal_background_color: { type: "string", label: "Subtotal BG Color", display: "color", default: "#f0f0f0", section: "Series", order: 79 },
    show_grand_total: { type: "boolean", label: "Show Grand Total Row", default: false, section: "Series", order: 80 },
    grand_total_label: { type: "string", label: "Grand Total Label", default: "Grand Total", section: "Series", order: 81 },
