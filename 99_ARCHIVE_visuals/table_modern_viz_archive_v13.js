...
Prompt to debug this version

good progress, below are the remaining bugs remain,

- pagination AND lookml drill fields do not work with OR without pivot, it used to work with the version 4.32.1 so do check it out ?

- grouping of columns works well but it should be included in the feature "freeze header row"

- the conditional row/ column formatting do not work FOR PIVOT except, weirdly, for CONTAINS type of rules for ROW formatting

- the null values of the measure row DETAILS (i.e. NOT the subtotal or grand total rows) should have a "-" by default for MEASURE and be empty (i.e "") for dimensions. Both element should be customizable through a two field added to the "Cells" section of the "formatting" tab

Please add console logs about those feature to help you deliver them asap
